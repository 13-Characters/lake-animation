...
def get_color(sun_azimuth, sun_altitude,
    ...
    if not all([x != None for x in
                [eastcolor1, eastcolor2, westcolor1, westcolor2, keyframe1, keyframe2]]):
        raise ValueError
    ...
    for i, element in enumerate(sun_copy.childNodes):
        ...
        if i < 4:
            element.setAttribute("style",
                                 f"display:inline;opacity:1;fill:{color_to_hex_value(sun_glow_color)};fill-opacity:0.0538922;stroke:none;")
        else:
            element.setAttribute("style",
                                 f"display:inline;fill:{color_to_hex_value(sun_color)};fill-opacity:1;stroke:none;")
...
def place_clouds(x, sun_azimuth, sun_altitude):
    ...
    elements = [element for element in clouds_copy.childNodes if
    ...
    if (sun_altitude > 0):
        cloud_color = get_color(sun_azimuth = sun_azimuth, sun_altitude = sun_altitude,
                                ...
                                keyframe1 = daytime_to_sunset_start,
                                keyframe2 = daytime_to_sunset_end)
    if (-0.08 * math.pi < sun_altitude <= 0):
        cloud_color = get_color(sun_azimuth = sun_azimuth, sun_altitude = sun_altitude,
                                ...
                                keyframe1 = sunset_to_twilight_start,
                                keyframe2 = sunset_to_twilight_end)
    if (sun_altitude <= -0.08 * math.pi):
        cloud_color = get_color(sun_azimuth = sun_azimuth, sun_altitude = sun_altitude,
                                eastcolor1 = night_color, eastcolor2 = dawn_color,
                                westcolor1 = night_color, westcolor2 = dusk_color,
                                keyframe1 = twilight_to_night_start,
                                keyframe2 = twilight_to_night_end)
    for element in pattern.childNodes[3].childNodes[1].childNodes:
        if element.nodeName == "path":
            element.setAttribute("style",
                                 f"display:inline;fill:{color_to_hex_value(cloud_color)};fill-opacity:1;stroke:none;")
...
def recolor_mountains(sun_azimuth, sun_altitude):
    ...
    if (sun_altitude > 0):
        foreground_color = get_color(sun_azimuth, sun_altitude,
                                     eastcolor1 = sunrise_colors["foreground"],
                                     eastcolor2 = daytime_colors["foreground"],
                                     westcolor1 = sunset_colors["foreground"],
                                     westcolor2 = daytime_colors["foreground"],
                                     keyframe1 = daytime_to_sunset_start,
                                     keyframe2 = daytime_to_sunset_end)
        background_color = get_color(sun_azimuth, sun_altitude,
                                     eastcolor1 = sunrise_colors["background"],
                                     eastcolor2 = daytime_colors["background"],
                                     westcolor1 = sunset_colors["background"],
                                     westcolor2 = daytime_colors["background"],
                                     keyframe1 = daytime_to_sunset_start,
                                     keyframe2 = daytime_to_sunset_end)
    if (-0.08 * math.pi < sun_altitude <= 0):
        foreground_color = get_color(sun_azimuth, sun_altitude,
                                     eastcolor1 = dawn_colors["foreground"],
                                     eastcolor2 = sunrise_colors["foreground"],
                                     westcolor1 = dusk_colors["foreground"],
                                     westcolor2 = sunset_colors["foreground"],
                                     keyframe1 = sunset_to_twilight_start,
                                     keyframe2 = sunset_to_twilight_end)
        background_color = get_color(sun_azimuth, sun_altitude,
                                     eastcolor1 = dawn_colors["background"],
                                     eastcolor2 = sunrise_colors["background"],
                                     westcolor1 = dusk_colors["background"],
                                     westcolor2 = sunset_colors["background"],
                                     keyframe1 = sunset_to_twilight_start,
                                     keyframe2 = sunset_to_twilight_end)
    if (sun_altitude <= -0.08 * math.pi):
        foreground_color = get_color(sun_azimuth, sun_altitude,
                                     eastcolor1 = night_colors["foreground"],
                                     eastcolor2 = dawn_colors["foreground"],
                                     westcolor1 = night_colors["foreground"],
                                     westcolor2 = dusk_colors["foreground"],
                                     keyframe1 = twilight_to_night_start,
                                     keyframe2 = twilight_to_night_end)
        background_color = get_color(sun_azimuth, sun_altitude,
                                     eastcolor1 = night_colors["background"],
                                     eastcolor2 = dawn_colors["background"],
                                     westcolor1 = night_colors["background"],
                                     westcolor2 = dusk_colors["background"],
                                     keyframe1 = twilight_to_night_start,
                                     keyframe2 = twilight_to_night_end)
        ...
        if layer.hasAttribute("id"):
            if layer.getAttribute("id") == "foreground":
                layer.setAttribute("style",
                                   f"display:inline;fill:{color_to_hex_value(foreground_color)};fill-opacity:1;stroke:none;")
            if layer.getAttribute("id") == "midground":
                layer.setAttribute("style",
                                   f"display:inline;fill:{color_to_hex_value(midground_color)};fill-opacity:1;stroke:none;")
            if layer.getAttribute("id") == "background":
                layer.setAttribute("style",
                                   f"display:inline;fill:{color_to_hex_value(background_color)};fill-opacity:1;stroke:none;")
...
def recolor_islands(sun_azimuth, sun_altitude):
    ...
    if (sun_altitude <= -0.08 * math.pi):
        ...
        background_color = get_color(sun_azimuth, sun_altitude,
                                     ...
                                     keyframe1 = twilight_to_night_start,
                                     keyframe2 = twilight_to_night_end)
    background_island.setAttribute("style",
                                   f"display:inline;opacity:1;fill:{color_to_hex_value(background_color)};fill-opacity:1;stroke:none;")
    foreground_island.setAttribute("style",
                                   f"display:inline;opacity:1;fill:{color_to_hex_value(foreground_color)};fill-opacity:1;stroke:none;")
    background_island_reflection.setAttribute("style",
                                              f"display:inline;opacity:1;fill:{color_to_hex_value(background_color)};fill-opacity:1;stroke:none;")
    foreground_island_reflection.setAttribute("style",
                                              f"display:inline;opacity:1;fill:{color_to_hex_value(foreground_color)};fill-opacity:1;stroke:none;")
...
def change_duck_opacity(altitude):
    ...
    duck_reflection.setAttribute("style",
                                 f"display:inline;opacity:{opacity};fill:#16141f;fill-opacity:1;stroke:none;")
...
def recolor_sky(sun_azimuth, sun_altitude):
    ...
    daytime_to_sunset_start = {"top": math.pi * 0.16,
                               "bottom": math.pi * 0.25}  # Seems more natural if bottom changes before top
    ...
    for i, part in enumerate(["top", "bottom"]):
        if (sun_altitude > 0):
            sky_color = get_color(sun_azimuth, sun_altitude,
                                  eastcolor1 = sunrise_colors[part],
                                  eastcolor2 = daytime_colors[part],
                                  westcolor1 = sunset_colors[part],
                                  westcolor2 = daytime_colors[part],
                                  keyframe1 = daytime_to_sunset_start[part],
                                  keyframe2 = daytime_to_sunset_end[part])
            reflection_color = get_color(sun_azimuth, sun_altitude,
                                         eastcolor1 = sunrise_colors[part + "_reflection"],
                                         eastcolor2 = daytime_colors[part + "_reflection"],
                                         westcolor1 = sunset_colors[part + "_reflection"],
                                         westcolor2 = daytime_colors[part + "_reflection"],
                                         keyframe1 = daytime_to_sunset_start[x(part)],
                                         keyframe2 = daytime_to_sunset_end[x(part)])
        if (-0.08 * math.pi < sun_altitude <= 0):
            sky_color = get_color(sun_azimuth, sun_altitude,
                                  eastcolor1 = dawn_colors[part], eastcolor2 = sunrise_colors[part],
                                  westcolor1 = dusk_colors[part], westcolor2 = sunset_colors[part],
                                  keyframe1 = sunset_to_twilight_start[part],
                                  keyframe2 = sunset_to_twilight_end[part])
            reflection_color = get_color(sun_azimuth, sun_altitude,
                                         eastcolor1 = dawn_colors[part + "_reflection"],
                                         eastcolor2 = sunrise_colors[part + "_reflection"],
                                         westcolor1 = dusk_colors[part + "_reflection"],
                                         westcolor2 = sunset_colors[part + "_reflection"],
                                         keyframe1 = sunset_to_twilight_start[x(part)],
                                         keyframe2 = sunset_to_twilight_end[x(part)])
        if (sun_altitude <= -0.08 * math.pi):
            sky_color = get_color(sun_azimuth, sun_altitude,
                                  eastcolor1 = night_colors[part], eastcolor2 = dawn_colors[part],
                                  westcolor1 = night_colors[part], westcolor2 = dusk_colors[part],
                                  keyframe1 = twilight_to_night_start[part],
                                  keyframe2 = twilight_to_night_end[part])
            reflection_color = get_color(sun_azimuth, sun_altitude,
                                         eastcolor1 = night_colors[part + "_reflection"],
                                         eastcolor2 = dawn_colors[part + "_reflection"],
                                         westcolor1 = night_colors[part + "_reflection"],
                                         westcolor2 = dusk_colors[part + "_reflection"],
                                         keyframe1 = twilight_to_night_start[x(part)],
                                         keyframe2 = twilight_to_night_end[x(part)])
        sky_stops[i].setAttribute("style",
                                  f"stop-color:{color_to_hex_value(sky_color)};stop-opacity:1;")
        reflection_stops[i].setAttribute("style",
                                         f"stop-color:{color_to_hex_value(reflection_color)};stop-opacity:1;")
...
def render(LATITUDE, LONGITUDE, time):
    ...
    if sun_az_alt[1] < 0:
        for star in star_data:
            star_az_alt = sky_utils.equatorial_to_az_alt(float(star["RA"]), float(star["DEC"]),
                                                         rotation, LATITUDE)
